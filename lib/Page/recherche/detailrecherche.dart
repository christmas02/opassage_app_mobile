...
class DetailRecherche extends StatefulWidget {
  final String name;
  ...
  @override
  _DetailRechercheState createState() => _DetailRechercheState();
}

class _DetailRechercheState extends State<DetailRecherche> {
  final urlImages = [
