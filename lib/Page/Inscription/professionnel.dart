...
class Professionnel extends StatefulWidget {
  Professionnel({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                      'Vous etes un responsable d\'espace hotelier ou un proprietaire d\'espace coworking ou de residence meublée ou autres espaces locatifs, cette application est faite pour vous'),
                ),
              ),
            ),
            Padding(
